...
* **Segurança na Aquisição de Sinais:** A captação de dados elétricos ocorrerá de maneira protegida, empregando sensores com isolação robusta, a exemplo dos Transformadores de Corrente (TCs) de núcleo bipartido.
